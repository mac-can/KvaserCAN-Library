...
echo " *" >> Sources/build_no.h
echo " *  MacCAN-KvaserCAN is dual-licensed under the BSD 2-Clause \"Simplified\" License" >> Sources/build_no.h
...
echo " *  OF MacCAN-KvaserCAN, EVEN IF ADVISED OF THE POSSIBILITY OF SUCH DAMAGE." >> Sources/build_no.h
echo " *" >> Sources/build_no.h
echo " *  GNU General Public License v3.0 or later:" >> Sources/build_no.h
echo " *  MacCAN-KvaserCAN is free software: you can redistribute it and/or modify" >> Sources/build_no.h
...
echo " *" >> Sources/build_no.h
echo " *  MacCAN-KvaserCAN is distributed in the hope that it will be useful," >> Sources/build_no.h
...
echo " *  along with MacCAN-KvaserCAN.  If not, see <http://www.gnu.org/licenses/>." >> Sources/build_no.h
echo " */" >> Sources/build_no.h
