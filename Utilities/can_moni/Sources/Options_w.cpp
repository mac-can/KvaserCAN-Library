...
#define ABOUT             44
#define CHARACTER_MJU     45
#define VERSION           46
#define MAX_OPTIONS       47
...
int SOptions::ScanCommanline(int argc, const char* argv[], FILE* err, FILE* out) {
    ...
    CCanMessage::EFormatTimestamp modeTime = CCanMessage::OptionZero;
    CCanMessage::EFormatNumber modeId = CCanMessage::OptionHex;
    CCanMessage::EFormatNumber modeData = CCanMessage::OptionHex;
    CCanMessage::EFormatOption modeAscii = CCanMessage::OptionOn;
    CCanMessage::EFormatWraparound wraparound = CCanMessage::OptionWraparoundNo;
